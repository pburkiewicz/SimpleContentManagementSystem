...
<ul>
    @forelse ( $comments as  $comment)
        ...
        @endif
        @if (Auth::user() and (Auth::user() == $comment->user or Auth::user() == $blog->user or $coworkers and  Auth::user()->id == $coworkers->user_id))  {{-- owner of the comment and owner of the post are able to delete a comment --}}
